...
// 4. Test the function with both test datasets
...
// Test data:
// § Data 3: [5, 2, 4, 1, 15, 8, 3]
// § Data 4: [16, 6, 10, 5, 6, 1, 4]
...
console.log(calcAverageHumanAge3(data1)); 

// Test Data 4
const data4 = [16, 6, 10, 5, 6, 1, 4];
console.log(calcAverageHumanAge3(data2));
...
// 1. Calculate the recommended food portion and add it to the dog objects
dogs.forEach(dog => dog.recommendedFood = Math.trunc(dog.weight ** 0.75 * 28));

console.log(dogs); // Just to see the dogs array with recommendedFood property added
...
// 3. Create arrays for owners whose dogs eat too much or too little
...
// 4. Log the strings for each array
...
// 6. Log if any dog is eating an okay amount of food
